    ...
    <section class="home-section">
        ...
        <div class="listprojet">
            <section id="tasks" class="mb-8">
                ...
                <button onclick="openForm()" class="bg-blue-500 text-white py-2 px-4 rounded inline-block mb-4 hover:bg-blue-600">Créer une nouvelle tâche</button>
                ...
                <table class="w-full bg-white shadow-md rounded-lg overflow-hidden">
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4">
                            <a href="listProjets.jsp?id=0" class="text-red-500 hover:underline">Voir</a>
                            ...
                            <a href="deleteTask.jsp?id=0" class="text-red-500 hover:underline">Voir</a>
                        </td>
                    </tr>
