            ...
            <table class="min-w-full bg-white border border-gray-300">
                ...
                <tr>
                    ...
                    <td class="py-2 px-4 border">
                        <a href="projets?action=edit&id=<%= projet.getId() %>" class="text-blue-500 hover:underline"><i class="fa-solid fa-pen"></i></a> |
                        <a href="projets?action=delete&id=<%= projet.getId() %>" class="text-red-500 hover:underline" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce projet ?');"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
                <%
                    }
